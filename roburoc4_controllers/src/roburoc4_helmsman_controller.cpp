...
class HelmsmanControllerNode {
	...
	private:
		...
		void statesCallback(const roburoc4_state_estimator::States::ConstPtr& states);
		void lineSegmentCallback(const roburoc4_controllers::LineSegment::ConstPtr& lSeg);
		...
		roburoc4_controllers::LineSegment lineSegment;
...
HelmsmanControllerNode::HelmsmanControllerNode() {
		...
		stateSub_ = nh_.subscribe<roburoc4_state_estimator::States>("roburoc4_state_estimator/states", 1 , &HelmsmanControllerNode::statesCallback, this);
		
		/* Subscriber for the LineSegments */
		lineSegmentSub_ = nh_.subscribe<roburoc4_controllers::LineSegment>("roburoc4_controllers/lineSegment", 1 , &HelmsmanControllerNode::lineSegmentCallback, this);
...
void HelmsmanControllerNode::statesCallback(const roburoc4_state_estimator::States::ConstPtr& newStates){
...
void HelmsmanControllerNode::lineSegmentCallback(const roburoc4_controllers::LineSegment::ConstPtr& lSeg){
