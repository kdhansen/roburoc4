...
#include <roburoc4_controllers/Trajectory.h>
...
class TrajectoryControllerNode {
	...
	private:
		...
		void trajectoryCallback(const roburoc4_controllers::Trajectory::ConstPtr& trajectory);
		...
		vector<roburoc4_controllers::TrajectoryPoints> points;
		vector<roburoc4_controllers::TrajectoryPoints>::iterator pointsIt;		
		
		/* Current states */
		roburoc4_state_estimator::States states;
...
TrajectoryControllerNode::TrajectoryControllerNode() {
		...
		trajectorySub_ = nh_.subscribe<roburoc4_controllers::Trajectory>("roburoc4_controllers/trajectory", 1 , &TrajectoryControllerNode::trajectoryCallback, this);
		
		/* Subscriber for the states */
		stateSub_ = nh_.subscribe<roburoc4_state_estimator::States>("roburoc4_state_estimator/states", 1 , &TrajectoryControllerNode::statesCallback, this);
...
void TrajectoryControllerNode::trajectoryCallback(const roburoc4_controllers::Trajectory::ConstPtr& trajectory){
...
void TrajectoryControllerNode::statesCallback(const roburoc4_state_estimator::States::ConstPtr& newStates){
